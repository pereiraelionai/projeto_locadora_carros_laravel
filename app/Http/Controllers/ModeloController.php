...
class ModeloController extends Controller
{
    ...
    {   
        ...
        if($request->has('attr_marca')) {
            $attr_marca = 'marca:id,'.$request->attr_marca;
            $modeloRepository->selectAttrRegistrosSelecionados($attr_marca);
        } else {
            $modeloRepository->selectAttrRegistrosSelecionados('marca');
        }
        ...
        if($request->has('attr_marca')) {
            ...
            $modelos = $this->modelo->with('marca:id,'.$attr_marca);
        } else {
